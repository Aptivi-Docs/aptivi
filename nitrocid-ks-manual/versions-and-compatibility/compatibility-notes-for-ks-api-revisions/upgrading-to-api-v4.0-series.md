...
## <mark style="color:$primary;">From 0.2.0.6 to 0.2.0.15</mark> <a href="#from-0.0.24-to-0.1.0" id="from-0.0.24-to-0.1.0"></a>

This version is built on top of 0.2.0 to integrate changes made to Terminaux.

### <mark style="color:$primary;">Updated Terminaux to 8.6</mark> <a href="#updated-terminaux-to-6.0" id="updated-terminaux-to-6.0"></a>

We've updated Terminaux to 8.6 to bring improvements. However, this doesn't come without the cost of having to deal with the breaking changes, which, in this case, is many.

You can consult the list of breaking changes that result from upgrading to Terminaux 8.6 by pressing the below button:
...
This section explains how to adapt the important changes to your mod code so that it works with this revision of 0.2.0 and higher. This highlights the most important changes that we have compiled for you.

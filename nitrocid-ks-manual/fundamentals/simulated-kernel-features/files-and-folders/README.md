...
<summary>Changing UNIX permissions</summary>

By pressing `U` on a file or a directory, you can change the UNIX permissions from the set ones.

{% hint style="danger" %}
This functionality is unavailable on Windows.
{% endhint %}

...
{% hint style="danger" %}
You can no longer sign in to your Google account here in Nitrocid as of **May 30, 2022** with your password, unless you use app passwords [here](https://myaccount.google.com/apppasswords). We currently don't have plans to fix this.
{% endhint %}
...
In the normal UESH shell, execute the `mail <address>` command to provide the credentials needed. Additionally, you can use POP3 mail using `popmail <address>`
{% endstep %}

...
{% hint style="info" %}
Additional widgets may be provided by addons and/or mods.
{% endhint %}
...
{% hint style="info" %}
The strings that the render function returns will be printed raw to the console by Nitrocid using the available Terminaux functions, so make sure that you use the `Render` variants of the writers.
...
For example, [here](https://github.com/Aptivi/Nitrocid/blob/main/public/Nitrocid.Base/Misc/Widgets/Implementations/AnalogClock.cs) is the implementation of the analog clock widget.
{% endhint %}

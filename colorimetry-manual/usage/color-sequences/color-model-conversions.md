...
## <mark style="color:$primary;">How to convert color models</mark>
...
{% hint style="info" %}
You can also specify a type of color model in both the generic and the non-generic versions of the functions.
{% endhint %}
